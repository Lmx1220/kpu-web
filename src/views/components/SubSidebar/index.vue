...
const enableSidebar = computed(() => {
  return ['side', 'head', 'single'].includes(settingsStore.settings.menu.mode)
})
...
<template>
  ...
  >
    ...
    <div
      v-if="settingsStore.settings.menu.enableSubMenuCollapseButton"
