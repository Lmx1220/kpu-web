...
import ResourceApi from './ResourceApi.vue'
import { ActionEnum, DictEnum } from '@/enums/commonEnum.ts'
import crudResource from '@/api/modules/devOperation/application/defResource.ts'
...
const data = ref<FormConfig<DefResourceResultVO>>({
  loading: false,
  form: {
    ...defaultForm,
  },
