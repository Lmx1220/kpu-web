    ...
    <template v-if="type === 'default'">
      ...
      <div>
        <ElFormItem prop="account">
          <ElInput v-model="form.account" :placeholder="t('loginFrom.form.account')" type="text" tabindex="1">
            <template #prefix>
        ...
        <ElFormItem prop="password">
          <ElInput v-model="form.password" type="password" :placeholder="t('loginFrom.form.password')" tabindex="2" show-password @keyup.enter="handleLogin">
            <template #prefix>
