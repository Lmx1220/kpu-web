        ...
        <ElCol :md="24" :lg="12">
          <ElForm ref="form" :model="form" label-width="120px">
            ...
            <ElFormItem label="活动时间">
              <ElCol :span="11">
                <!-- <ElDatePicker v-model="form.date1" type="date" :default-value="new Date()" placeholder="选择日期" style="width: 100%;" /> -->
              </ElCol>
              <ElCol class="line" :span="2">
                -
              </ElCol>
              <ElCol :span="11">
                <!-- <ElTimePicker v-model="form.date2" :default-value="new Date()" placeholder="选择时间" style="width: 100%;" /> -->
              </ElCol>
            </ElFormItem>
            ...
            <ElFormItem label="活动性质">
              <ElCheckboxGroup v-model="form.type">
                <ElCheckbox value="美食/餐厅线上活动" name="type" />
                <ElCheckbox value="地推活动" name="type" />
                <ElCheckbox value="线下主题活动" name="type" />
                <ElCheckbox value="单纯品牌曝光" name="type" />
              </ElCheckboxGroup>
            </ElFormItem>
            <ElFormItem label="特殊资源">
              <ElRadioGroup v-model="form.resource">
                <ElRadio value="线上品牌商赞助" />
                <ElRadio value="线下场地免费" />
              </ElRadioGroup>
            </ElFormItem>
