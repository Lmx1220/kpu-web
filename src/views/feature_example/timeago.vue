...
<template>
  <div>
    <KpuPageHeader title="可阅读时间" content="将时间格式化可阅读的格式" />
    <KpuPageMain title="指令（基础使用）">
