  ...
  <div class="upload-container">
    ...
    >
      <div class="image-slot" :style="`width:${width}px;height:${height}px;`">
        <KIcon name="i-ep:plus" class="icon" />
      </div>
