  ...
  <div>
    <el-drawer v-model="isShow" title="应用配置" direction="rtl" :size="360">
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.menu.switchMainMenuAndPageJump" :disabled="['single', 'only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      <div class="setting-item">
        <div class="label">
          次导航自动隐藏
        ...
        <el-switch v-model="settingsStore.settings.menu.subMenuOnlyOneHide" :disabled="['single', 'only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      <div class="setting-item">
        <div class="label">
          次导航保持展开一个
        ...
        <el-switch v-model="settingsStore.settings.menu.subMenuUniqueOpened" :disabled="['only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      <div class="setting-item">
        <div class="label">
          次导航是否折叠
        </div>
        <el-switch v-model="settingsStore.settings.menu.subMenuCollapse" :disabled="['only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      <div v-if="settingsStore.mode === 'pc'" class="setting-item">
        <div class="label">
          显示次导航折叠按钮
        </div>
        <el-switch v-model="settingsStore.settings.menu.enableSubMenuCollapseButton" :disabled="['only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      <div class="setting-item">
        <div class="label">
          是否启用快捷键
        </div>
        <el-switch v-model="settingsStore.settings.menu.enableHotkeys" :disabled="['only-side', 'only-head'].includes(settingsStore.settings.menu.menuMode)" />
      </div>
      ...
      <div class="setting-item">
        ...
        <el-select v-model="settingsStore.settings.tabbar.mergeTabsBy" size="small" :disabled="!settingsStore.settings.tabbar.enable">
      ...
      <div class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.tabbar.enableMemory" :disabled="!settingsStore.settings.tabbar.enable" />
      </div>
      <div class="setting-item">
        <div class="label">
          是否启用快捷键
        </div>
        <el-switch v-model="settingsStore.settings.tabbar.enableHotkeys" :disabled="!settingsStore.settings.tabbar.enable" />
      </div>
      ...
      <div v-if="settingsStore.mode === 'pc'" class="setting-item">
        ...
        <el-switch v-model="settingsStore.settings.breadcrumb.enableMainMenu" :disabled="['single'].includes(settingsStore.settings.menu.menuMode) || !settingsStore.settings.breadcrumb.enable" />
      </div>
      <el-divider>
        页面
      </el-divider>
